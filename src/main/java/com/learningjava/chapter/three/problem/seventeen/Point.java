package com.learningjava.chapter.three.problem.seventeen;
...
public class Point {
    ...
    public boolean equals(Object other) {
        ...
        equal if 'other' is of type Point(or one of its derived classes), then downcast
        the object to Point type and then compare members for equality
         */
